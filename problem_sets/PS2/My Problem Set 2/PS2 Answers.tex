...
\begin{enumerate}
	...
	\vspace{7cm}
	\lstinputlisting[language=R, firstline=6, lastline=55]{PS2_R_Code.R} 
	...
	\lstinputlisting[language=R, firstline=59, lastline=61]{PS2_R_Code.R} 
	
	\newpage
	\item [(c)] Calculate the standardized residuals for each cell and put them in the table below.
	\vspace{1cm}
	\lstinputlisting[language=R, firstline=64, lastline=88]{PS2_R_Code.R} 
...
Alternative Hypothesis: There is an effect from the reservation policy on the number of new or repaired drinking water facilities in the villages
	...
	\lstinputlisting[language=R, firstline=104, lastline=111]{PS2_R_Code.R} 
	\includegraphics[width=.1\textwidth]{plot2-B-first.pdf}
	\includegraphics[width=.1\textwidth]{plot2-B.pdf}
There seems to be very little change in the water situation as a whole in all GP locations with a near-zero slope, indicating a lack of change per GP. With irrigation however, as water increased, irrigation seemed to also increase. The difficult aspect of this interpretation however, is the lack of data points at the larger end of the scope.
	...
	\lstinputlisting[language=R, firstline=114, lastline=119]{PS2_R_Code.R}
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=128, lastline=143]{PS2_R_Code.R}
\newpage
	\item
	...
	\lstinputlisting[language=R, firstline=157, lastline=168]{PS2_R_Code.R}
...
\lstinputlisting[language=R, firstline=172, lastline=175]{PS2_R_Code.R}
	...
	\lstinputlisting[language=R, firstline=178, lastline=188]{PS2_R_Code.R}
\newpage
	\item
	...
	\lstinputlisting[language=R, firstline=191, lastline=206]{PS2_R_Code.R}
	...
	\lstinputlisting[language=R, firstline=209, lastline=220]{PS2_R_Code.R}
	...
	\lstinputlisting[language=R, firstline=223, lastline=228]{PS2_R_Code.R}
\includegraphics{plot3-7.pdf}
